...
pub const CHUNK_REQUEST_RETRY_MS: u64 = 500;
pub const CHUNK_REQUEST_SWITCH_TO_OTHERS_MS: u64 = 1_000;
pub const CHUNK_REQUEST_SWITCH_TO_FULL_FETCH_MS: u64 = 4_000;
